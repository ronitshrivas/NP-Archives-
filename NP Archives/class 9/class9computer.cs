...
namespace NP_Archives
{
    ...
    {
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1ds1jhF7tnA5AxJkOGHuGfpPuxy20mlCT";
        private string pdfFileName = "class9computertextbook"; // The name you want to save the PDF file with
        private string pdfFolderPath = Path.Combine(Application.StartupPath, "DownloadedPDFs");
        private string localFilePath;
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=1joKqrkNSjxCKV_KirWEWMK6RsJcQybtF";
        private string engpdfquestion = "class9computerquestionpaper"; //
        ...
        private async void button2_Click(object sender, EventArgs e)
        {
            ...
            downloadquestionapaper();
            button2.Text = string.Empty;
            button2.Text += "Please wait ....";
        }

        private async void downloadquestionapaper()
        {
            await initizated();

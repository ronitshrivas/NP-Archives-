...
{
    public partial class class9science : Form
    {
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1wEUcY3rut4e4_43NxES6xOayHr6JejTy";
        private string pdfFileName = "class9sciencetextbook"; // The name you want to save the PDF file with
        ...
        private string engpdfquestion = "class9modelquestionquestion"; //
        ...
        private string pdffilname = "class9questionpaper"; //
        ...
        private void class9science_Load(object sender, EventArgs e)
        {
            InitBrowser();
            LoadSettings();
            Loadmodelquestion();

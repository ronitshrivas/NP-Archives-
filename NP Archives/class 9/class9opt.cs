...
namespace NP_Archives
{
    public partial class class9opt : Form
    {
        ...
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1d0QZeIjwyqn8i1Z65aSjfu_MkNZG9SDl";
        private string pdfFileName = "class9opttextbook"; // The name you want to save the PDF file with

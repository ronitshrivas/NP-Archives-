...
namespace NP_Archives
{
    public partial class class10nepali : Form
    {
        ...
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=14Fy3iWUlIQECuHBAok2Knefi-jR-8T6Y";
        private string pdfFileName = "class10nepalitextbook"; // The name you want to save the PDF file with
        private string pdfFolderPath = Path.Combine(Application.StartupPath, "DownloadedPDFs");
        private string localFilePath;
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=17EBC07a3YOSRtXc4xURzWusvWXFA15LR";
        private string engpdfquestion = "class10nepalimodelquestion"; //

...
{
    public partial class class10maths : Form
    {
        private bool textbookpdf;
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1EvNwzQZ98eiOwCUvKMdn1ZWkf37Otv36";
        private string pdfFileName = "class10mathstextbook"; // The name you want to save the PDF file with
        private string pdfFolderPath = Path.Combine(Application.StartupPath, "DownloadedPDFs");
        private string localFilePath;
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=1CxTGIu_0GTWGz_U0e1ZPvhMhBQUlfGhP";
        private string engpdfquestion = "class10mathsexamquestion"; //
        ...
        private void class10maths_Load(object sender, EventArgs e)
        {
            InitBrowser();
            LoadSettings();
            Loadmodelquestion();
        ...
        {
            await initizated();
            //webView21.CoreWebView2.Navigate("https://drive.google.com/uc?export=view&id=1EvNwzQZ98eiOwCUvKMdn1ZWkf37Otv36");
            //webView22.CoreWebView2.Navigate("https://drive.google.com/uc?export=view&id=1CxTGIu_0GTWGz_U0e1ZPvhMhBQUlfGhP");
        }

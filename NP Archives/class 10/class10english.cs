...
namespace NP_Archives
{
    ...
    {
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1ci11jejXST4HFI942PUHdqVtUaBOpuw8";
        private string pdfFileName = "class10englishtextbook"; // The name you want to save the PDF file with
        private string pdfFolderPath = Path.Combine(Application.StartupPath, "DownloadedPDFs");
        private string localFilePath;
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=1QY96my-P_fcYSREQNE8G8r6IBqio5JGh";
        private string engpdfquestion = "class10englishmodelquestion"; //
        private string localfilepaths;
        private string pdfurlpart3 = "https://drive.google.com/uc?export=view&id=1lM0nxMaOIp6O3QVsjnqfYg2_4nj6QGqr";
        private string pdffilname = "class10englishsamplequestion"; //

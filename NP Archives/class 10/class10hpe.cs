...
namespace NP_Archives
{
    public partial class class10hpe : Form
    {
        ...
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1cDAtPMZJLu-BQVYELhxEmv9HZ6KhLa03";
        private string pdfFileName = "class10hpequestion2076"; // The name you want to save the PDF file with
        private string pdfFolderPath = Path.Combine(Application.StartupPath, "DownloadedPDFs");
        private string localFilePath;
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=14xeD2gGRo3uB4TW4pfkiCYy0zBxK5cvC";
        private string engpdfquestion = "class10hpequestion2074"; //
        ...
        private async void download2076()
        {
            await initizated();
        ...
        private async void download2074()
        {
            await initizated();

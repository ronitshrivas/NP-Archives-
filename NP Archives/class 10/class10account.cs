...
{
    public partial class class10account : Form
    {
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1wEUcY3rut4e4_43NxES6xOayHr6JejTy";
        private string pdfFileName = "class10accounttextbook"; // The name you want to save the PDF file with
        ...
        private string engpdfquestion = "class10accountmodelquestion"; //
        ...
        private string pdffilname = "class10accountsamplequeston"; //
        private string localfilepath3;
        public class10account()
        {
            InitializeComponent();
        ...
        private void class10account_Load(object sender, EventArgs e)
        {

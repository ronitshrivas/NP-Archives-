...
namespace NP_Archives
{
    ...
    {
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=16REGOu4zP8EI7DfI9oyv8Ermtvka5xKC";
        private string pdfFileName = "class10ssttextbook"; // The name you want to save the PDF file with
        private string pdfFolderPath = Path.Combine(Application.StartupPath, "DownloadedPDFs");
        private string localFilePath;
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=1mkub-tjb6V7gMERqUFX0-B10uYyMY9Pz";
        private string engpdfquestion = "class10sstexamquestion"; //

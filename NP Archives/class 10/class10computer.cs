...
namespace NP_Archives.class_10
{
    public partial class class10computer : Form
    {
        ...
        private string pdfFileName = "Class10computertextbook"; // The name you want to save the PDF file with
        ...
        private string engpdfquestion = "class10computermodelquestion"; //

...
namespace NP_Archives
{
    ...
    {
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1HjxOQJDBS1vg_GRPBu8p1yfFvRnVOttm";
        private string pdfFileName = "class10sciencetextbook"; // The name you want to save the PDF file with
        private string pdfFolderPath = Path.Combine(Application.StartupPath, "DownloadedPDFs");
        private string localFilePath;
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=1kb5S9vzhiExcDeFfzn0klHLUuePGCZHA";
        private string engpdfquestion = "class10sciencewexamquestion"; //

...
namespace NP_Archives.bsc.csit.CSIT_2_sem
{
    ...
    {
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1XlPD0iZA1CPTE7VvpJRpS1sxKuWLmUxC";
        private string pdfFileName = "2semstatisticesexamquestion"; // The name you want to save the PDF file with
        ...
        {
            await initizated();
            String openPDFFile = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + @"Statistics I Syllabus 2sem.pdf";//PDF DOc name
            System.IO.File.WriteAllBytes(openPDFFile, Properties.Resources.Statistics_I_Syllabus_2sem);///the resource automatically creates            
            webView21.CoreWebView2.Navigate(openPDFFile);
            /*
            string opennotespdffile = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + @"Exam Question_statistics 2sem.pdf";
           // System.IO.File.WriteAllBytes(opennotespdffile, Properties.Resources.Exam_Question_statistics_2sem);///the resource automatically creates            

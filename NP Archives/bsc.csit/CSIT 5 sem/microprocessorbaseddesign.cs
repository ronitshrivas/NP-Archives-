...
namespace NP_Archives.bsc.csit.CSIT_5_sem
{
    public partial class microprocessorbaseddesign : Form
    {
        ...
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=1ewN_iupQfdTL3sruHGhW1NiKTTXSnubF";
        private string engpdfquestion = "csit5semMBDtextbookII"; //
        private string localfilepaths;
        private string pdfurlpart3 = "https://drive.google.com/uc?export=view&id=1EcPx63xuJGK6BfEDwQj8BFKq-vGYuzv7";
        private string pdffilname = "csit5semMBDtextbookIII"; //
        private string localfilepath3;
        private string pdfurlpart4 = "https://drive.google.com/uc?export=view&id=1Y96GJ3K6_gPZHz1yK9VShKg1j08sy0_D";
        private string pdffilname4 = "csit5semMBDexamquestion"; //

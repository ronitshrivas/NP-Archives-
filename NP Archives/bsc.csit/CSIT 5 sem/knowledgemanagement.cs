...
namespace NP_Archives.bsc.csit.CSIT_5_sem
{
    ...
    {
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1wBwvH83kGb8W1KQEAiq8JrtHKGDrW9nI";
        private string pdfFileName = "csit5semknowledgemanagementtextbook"; // The name you want to save the PDF file with
        private string pdfFolderPath = Path.Combine(Application.StartupPath, "DownloadedPDFs");
        private string localFilePath;
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=1UUARYxT1Xgx-Gja7y5o2GC3ZD4Zz2-PI";
        private string engpdfquestion = "csit5semknowledgemanagementexamquestion"; //
        ...
        {
            await initizated();
            String openPDFFile = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + @"Knowledge Management Syllabus.pdf";//PDF DOc name
            System.IO.File.WriteAllBytes(openPDFFile, Properties.Resources.Knowledge_Management_Syllabus);///the resource automatically creates            
            webView21.CoreWebView2.Navigate(openPDFFile);
            /*
            string opennotespdffile = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + @"Knowledge Management ( PDFDrive ).pdf";
            //System.IO.File.WriteAllBytes(opennotespdffile, Properties.Resources.Knowledge_Management___PDFDrive__);///the resource automatically creates            

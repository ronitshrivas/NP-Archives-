...
namespace NP_Archives.bsc.csit.CSIT_3_sem
{
    public partial class numericalmethod : Form
    {
        ...
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=1WDP7jQHQSY1_zeATxPM9xbGak15fLi0s";
        private string engpdfquestion = "csit3rdsemnumericalmethodexamquestion"; //
        private string localfilepaths;
        private string pdfurlpart3 = "https://drive.google.com/uc?export=view&id=1CpkTn3fhkmRShLOSoB6T1k1VaVLW2pVF";
        private string pdffilname = "csit3rdsemnumericalmethodlabsheets"; //
        private string localfilepath3;
        private string pdfurlpart4 = "https://drive.google.com/uc?export=view&id=1zz5f9z4lWJ-BVkwArqvo88SXvQQ_eYZg";
        private string pdffilname4 = "csit3rdsemnumericalmethodtextbook"; //
        private string localfilepath4;
        private string pdfurlpart5 = "https://drive.google.com/uc?export=view&id=12lSP96ZICmwKeMGwg_Li9f7GQ4LG7dg5";
        private string pdffilname5 = "csit3rdsemnumericalmethodoldisgoldsoln"; //
        ...
        private async void InitBrowser()
        {
            ...
            System.IO.File.WriteAllBytes(openPDFFile, Properties.Resources.Numerical_Method_Syllabus);///the resource automatically creates            
           ...
           // System.IO.File.WriteAllBytes(opennotespdffile, Properties.Resources.Numerical_Methods_Handwritten_Notes);///the resource automatically creates            
           ...
           // System.IO.File.WriteAllBytes(openexampdffile, Properties.Resources.Nummethod_Exam_Question);///the resource automatically creates            
            webView23.CoreWebView2.Navigate(openexampdffile);
            string labsheet = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + @"Exam Question_COA.pdf";
          //  System.IO.File.WriteAllBytes(labsheet, Properties.Resources.Numerical_Methods_Labsheet);///the resource automatically creates            
            webView23.CoreWebView2.Navigate(labsheet);
            */
        ...
        private void numericalmethod_Load(object sender, EventArgs e)
        {
            ...
            loadoldisgoldsolution();
        }

        private async void loadoldisgoldsolution()
        {
            await initizated();

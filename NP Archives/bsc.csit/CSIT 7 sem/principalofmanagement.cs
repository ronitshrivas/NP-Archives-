...
namespace NP_Archives.bsc.csit.CSIT_7_sem
{
    ...
    {
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1BR33aH1oOwwyUrh65q3qaAt9ejiyAUjv";
        private string pdfFileName = "csit7sempomtextbook"; // The name you want to save the PDF file with
        private string pdfFolderPath = Path.Combine(Application.StartupPath, "DownloadedPDFs");
        private string localFilePath;
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=11bU3voEeBL3z5BUFV506hiCvGmlIlCs_";
        private string engpdfquestion = "csit7sempomexamquestion"; //
        private string localfilepaths;
        private string pdfurlpart3 = "https://drive.google.com/uc?export=view&id=1Sax8OnYlBJcdCk3dbbzewxx2QyYnrf1Q";
        private string pdffilname = "csit7sempomnote"; //

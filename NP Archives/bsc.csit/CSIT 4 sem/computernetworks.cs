...
namespace NP_Archives.bsc.csit.CSIT_4_sem
{
    public partial class computernetworks : Form
    {
        ...
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=1hhV8xYr3_xMNg1ixSwZPWtxQqqkCv-yA";
        private string engpdfquestion = "csit4semcomputernetworksexamquestion"; //
        private string localfilepaths;
        private string pdfurlpart3 = "https://drive.google.com/uc?export=view&id=1OWDyrIaLeOyqJMe40vcCEk2pfBhYv7Tt";
        private string pdffilname = "csit4semcomputernetworkstextbookI"; //
        private string localfilepath3;
        private string pdfurlpart4 = "https://drive.google.com/uc?export=view&id=1VNfSNOxVVhImstw7oMv4j_o-mVIiYhaz";
        private string pdffilname4 = "csit4semcomputernetworkstextbookII"; //

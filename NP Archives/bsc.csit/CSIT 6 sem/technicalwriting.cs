...
namespace NP_Archives.bsc.csit.CSIT_6_sem
{
    public partial class technicalwriting : Form
    {
        ...
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=1WiLoukh5WLAsPb1zVYbPPfKcpdjydXny";
        private string engpdfquestion = "csit6semtechnicalwritingexamquestion"; //
        private string localfilepaths;
        private string pdfurlpart3 = "https://drive.google.com/uc?export=view&id=1IUHGS00vdiUHe3WGf4H6kqFJ8mBa0B9p";
        private string pdffilname = "csit6semtechnicalwritingmodelquestion"; //
        ...
        {
            await initizated();
            String openPDFFile = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + @"Technical Writing Syllabus.pdf";//PDF DOc name
            System.IO.File.WriteAllBytes(openPDFFile, Properties.Resources.Technical_Writing_Syllabus);///the resource automatically creates            
            webView21.CoreWebView2.Navigate(openPDFFile);
            /*
            string opennotespdffile = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + @"Technical Writing Handwritten Note_removed.pdf";
          //  System.IO.File.WriteAllBytes(opennotespdffile, Properties.Resources.Technical_Writing_Handwritten_Note_removed);///the resource automatically creates            
            webView22.CoreWebView2.Navigate(opennotespdffile);
            string openexampdffile = Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments) + @"Technical Wriyting Exam Question.pdf";
         //   System.IO.File.WriteAllBytes(openexampdffile, Properties.Resources.Technical_Wriyting_Exam_Question);///the resource automatically creates            

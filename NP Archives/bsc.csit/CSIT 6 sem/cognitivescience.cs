...
namespace NP_Archives.bsc.csit.CSIT_6_sem
{
    ...
    {
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1W1bDyP0vgZ0dBah4sfylKvHUc3XXDEcO";
        private string pdfFileName = "csit6semcognitivesciencemodelquestion"; // The name you want to save the PDF file with
        private string pdfFolderPath = Path.Combine(Application.StartupPath, "DownloadedPDFs");
        private string localFilePath;
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=1dmKsz_R12ZAmvCkISXqCnJ8A7m4ZLNNg";
        private string engpdfquestion = "csit6semcognitivescienceexamquestion"; //

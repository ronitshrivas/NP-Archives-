...
namespace NP_Archives.bsc.csit.CSIT_6_sem
{
    public partial class neuralnetwork : Form
    {
        ...
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1Q_5IaG9_mOhhSCq7Rte-8B-LBLfGCXVd";
        private string pdfFileName = "csit6semneuralnetworksmodelquestion"; // The name you want to save the PDF file with
        private string pdfFolderPath = Path.Combine(Application.StartupPath, "DownloadedPDFs");
        private string localFilePath;
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=1oH104Qf6KdaYYnb8RkQIpotXyfakjns7";
        private string engpdfquestion = "csit6semneuralnetworksTexbook"; //
        ...
        private async void neuralnetwork_Load(object sender, EventArgs e)
        {
            InitBrowser();
            loadmodelquestion();
            loadtextbook();
        ...
        private async void loadreferencebook()
        {
            await initizated();
        ...
        private async void button3_Click(object sender, EventArgs e)
        {
            ...
            downloadreferncebook();
            button3.Text = string.Empty;
            button3.Text += "Please wait ....";
        }

        private async void downloadreferncebook()
        {
            await initizated();

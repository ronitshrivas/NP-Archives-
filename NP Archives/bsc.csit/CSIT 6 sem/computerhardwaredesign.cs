...
namespace NP_Archives.bsc.csit.CSIT_6_sem
{
    ...
    {
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1Dbo53gu0YL6MNq5UfYAceAIHhsdBEP6F";
        private string pdfFileName = "csit6semcomputerhardwareanddesignmodelquestion"; // The name you want to save the PDF file with
        private string pdfFolderPath = Path.Combine(Application.StartupPath, "DownloadedPDFs");
        private string localFilePath;
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=1fu_GJAYHoo8upwOYq_HvopNTDRcVOi_t";
        private string engpdfquestion = "csit6semcomputerhardwareanddesigntextbookI"; //

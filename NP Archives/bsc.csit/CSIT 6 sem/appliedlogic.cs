...
namespace NP_Archives.bsc.csit.CSIT_6_sem
{
    ...
    {
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1jk-8IU4xyiKZJdFEYG7KvZTljqkYvFCD";
        private string pdfFileName = "csit6semappliedlogicmodelquestion"; // The name you want to save the PDF file with

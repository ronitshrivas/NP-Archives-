...
namespace NP_Archives.class_12
{
    ...
    {
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1YOItaeTAsNMWr6sMrntRvvAVThb4NY2K";
        private string pdfFileName = "class12physicstextbook"; // The name you want to save the PDF file with
        private string pdfFolderPath = Path.Combine(Application.StartupPath, "DownloadedPDFs");
        private string localFilePath;
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=1K_52QP0PesN1tk-fcAski66R5aqKCfEA";
        private string engpdfquestion = "class12physicsoldisgoldsoln"; //
        private string localfilepaths;
        private string pdfurlpart3 = "https://drive.google.com/uc?export=view&id=1uDI_GT8b2StvsuDHn540nj4rFHM8lOi0";
        private string pdffilname = "class12physicsoldisgoldsquestion"; //
        private string localfilepath3;
        private string pdfurlpart4 = "https://drive.google.com/uc?export=view&id=1Eev3HRCMM0vfQQurVqjB33qFS3L_QriZ";
        private string pdffilname4 = "class12physicspracticalcopy"; //
        ...
        private async void button3_Click(object sender, EventArgs e)
        {
            ...
            downloadoldisgoldquestion();
            button3.Text = string.Empty;
            button3.Text += "Please wait ....";
        }

        private async void downloadoldisgoldquestion()
        {
            await initizated();

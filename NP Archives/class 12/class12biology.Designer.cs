namespace NP_Archives.class_12
{
    partial class class12biology
    {
        ...
        private void InitializeComponent()
        {
            ...
            oldisgoldsolution = new TabPage();
            button1 = new Button();
            webView21 = new Microsoft.Web.WebView2.WinForms.WebView2();
            oldisgoldquestionbank = new TabPage();
            button2 = new Button();
            webView22 = new Microsoft.Web.WebView2.WinForms.WebView2();
            tabControl1.SuspendLayout();
            oldisgoldsolution.SuspendLayout();
            ((System.ComponentModel.ISupportInitialize)webView21).BeginInit();
            oldisgoldquestionbank.SuspendLayout();
            ...
            tabControl1.Controls.Add(oldisgoldsolution);
            tabControl1.Controls.Add(oldisgoldquestionbank);
            ...
            // oldisgoldsolution
            // 
            oldisgoldsolution.BackColor = Color.FromArgb(45, 54, 76);
            oldisgoldsolution.Controls.Add(button1);
            oldisgoldsolution.Controls.Add(webView21);
            oldisgoldsolution.Location = new Point(4, 28);
            oldisgoldsolution.Name = "oldisgoldsolution";
            oldisgoldsolution.Padding = new Padding(3);
            oldisgoldsolution.Size = new Size(1202, 525);
            oldisgoldsolution.TabIndex = 0;
            oldisgoldsolution.Text = "Old is Gold Solution";
            // 
            // button1
            // 
            ...
            // 
            oldisgoldquestionbank.BackColor = Color.FromArgb(45, 54, 76);
            oldisgoldquestionbank.Controls.Add(button2);
            oldisgoldquestionbank.Controls.Add(webView22);
            oldisgoldquestionbank.Location = new Point(4, 28);
            oldisgoldquestionbank.Name = "oldisgoldquestionbank";
            oldisgoldquestionbank.Padding = new Padding(3);
            oldisgoldquestionbank.Size = new Size(1202, 525);
            oldisgoldquestionbank.TabIndex = 1;
            oldisgoldquestionbank.Text = "Old is Gold Question Bank";
            // 
            // button2
            // 
            ...
            Name = "class12biology";
            Text = "class12biology";
            Load += class12biology_Load;
            tabControl1.ResumeLayout(false);
            oldisgoldsolution.ResumeLayout(false);
            ((System.ComponentModel.ISupportInitialize)webView21).EndInit();
            oldisgoldquestionbank.ResumeLayout(false);

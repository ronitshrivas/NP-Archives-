...
namespace NP_Archives.class_12
{
    ...
    {
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=18IwRiAz8JWTZtJcjE_l40PIOyQGPYzGW";
        private string pdfFileName = "class12nepaliekchehan"; // The name you want to save the PDF file with
        private string pdfFolderPath = Path.Combine(Application.StartupPath, "DownloadedPDFs");
        private string localFilePath;
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=1ijf8pBaSWRQtRN-TwNZKvoyLDqlkU-ch";
        private string engpdfquestion = "class12nepalitextbook"; //
        ...
        private async void downloadekchehan()
        {
            await initizated();

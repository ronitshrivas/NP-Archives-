...
namespace NP_Archives.class_12
{
    ...
    {
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1ekW2IumBLbN_2NnCzeqHYGEuPKOHnbpx";
        private string pdfFileName = "class12zoologycopy"; // The name you want to save the PDF file with

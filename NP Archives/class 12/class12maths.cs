...
namespace NP_Archives.class_12
{
    public partial class class12maths : Form
    {
        ...
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1i610vfe-RC7h7Bl4eAi4pGUP9323UWur";
        private string pdfFileName = "class12mathstextbook"; // The name you want to save the PDF file with
        private string pdfFolderPath = Path.Combine(Application.StartupPath, "DownloadedPDFs");
        private string localFilePath;
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=14NaZm7zl8RgLr6uOTMn-4QdWu6tOWppN";
        private string engpdfquestion = "class12mathsoldisgoldmodelqst"; //
        ...
        private async void button2_Click(object sender, EventArgs e)
        {
            ...
            downloadoldisgoldmodelquestion();
            button2.Text = string.Empty;
            button2.Text += "Please wait ....";
        }

        private async void downloadoldisgoldmodelquestion()
        {
            await initizated();

...
namespace NP_Archives.class_11
{
    ...
    {
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1fT4WuLewvCIm9C0cCiyXSxXZIbYMJqFk";
        private string pdfFileName = "class11computersyallabus"; // The name you want to save the PDF file with
        private string pdfFolderPath = Path.Combine(Application.StartupPath, "DownloadedPDFs");
        private string localFilePath;
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=1QSi_Jrkc9XuPJC1GNp9MmGl-IWWk0Nsm";
        private string engpdfquestion = "class11computersamplequestion"; //
        ...
        private async void downloadsyallabus()
        {
            await initizated();

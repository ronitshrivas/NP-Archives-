...
namespace NP_Archives.class_11
{
    ...
    {
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1_-qHyrHzz1umjmHMhSXDZbF_wQTIcVtq";
        private string pdfFileName = "class11zologycopy"; // The name you want to save the PDF file with
        private string pdfFolderPath = Path.Combine(Application.StartupPath, "DownloadedPDFs");
        private string localFilePath;
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=1ImEXj4sO_M7_-inB_Z669HbeD-PioHSy";
        private string engpdfquestion = "class11zoobotsamplequestion"; //

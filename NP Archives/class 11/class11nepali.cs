...
namespace NP_Archives.class_11
{
    ...
    {
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1Q51SgtcNc1pj1oQYjM48-KOpaif3MC10";
        private string pdfFileName = "class11nepalitextbook"; // The name you want to save the PDF file with
        private string pdfFolderPath = Path.Combine(Application.StartupPath, "DownloadedPDFs");
        private string localFilePath;
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=1j6H4kZZbUq7HzBn0B5njNaEk5wIy0JId";
        private string engpdfquestion = "class11nepalimodelquestion"; //
        private string localfilepaths;
        private string pdfurlpart3 = "https://drive.google.com/uc?export=view&id=1PXSuBVeYyTrH_CxcG0ckaqwEI11Z7u6r";
        private string pdffilname = "class11nepalisamplequestion"; //

...
namespace NP_Archives.class_11
{
    ...
    {
        private string pdfUrl = "https://drive.google.com/uc?export=view&id=1vLnM2E1nrs6g3NuyGdFESo5_3prWvSe0";
        private string pdfFileName = "class11chemistrypracticalcpy"; // The name you want to save the PDF file with
        private string pdfFolderPath = Path.Combine(Application.StartupPath, "DownloadedPDFs");
        private string localFilePath;
        private string engpdfUrl = "https://drive.google.com/uc?export=view&id=1hFet7DZnQNW1-I-fa2zvr1pgxzU5M3va";
        private string engpdfquestion = "class11oldisgoldsoln1"; //
        private string localfilepaths;
        private string pdfurlpart3 = "https://drive.google.com/uc?export=view&id=1rCJUjfN6fxE-rev8tZv7_Gndy94DZU5L";
        private string pdffilname = "class11oldisgoldsoln2"; //
